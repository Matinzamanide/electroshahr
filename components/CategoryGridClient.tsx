...
const CategoryGrid = () => {
  ...
  return (
    <section className="py-24 bg-linear-to-b from-gray-50 via-white to-gray-50 overflow-hidden relative" dir="rtl">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(124,58,237,0.08),transparent_40%)]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(59,130,246,0.08),transparent_40%)]"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20 relative">
          ...
          <h2 className="text-5xl md:text-7xl font-extrabold mb-8 relative pt-10">
            <span className="bg-clip-text text-transparent bg-linear-to-r from-amber-500 via-orange-600 to-yellow-500 animate-linear-shift">
              دنیای
            </span>
            <span className="block mt-2 bg-clip-text text-transparent bg-linear-to-r from-indigo-700 via-purple-800 to-indigo-900">
              برق و روشنایی
          ...
          <p className="text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed relative z-10 flex items-center justify-center gap-4">
            <Sparkle className="text-amber-400 animate-spin-slow" size={36} />
            <span>محصولات با کیفیت و متنوع در دسته‌بندی‌های مختلف</span>
            <Sparkle className="text-indigo-600 animate-spin-slow-reverse" size={36} />
          </p>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-10">
            {[
              { number: "5000+", label: "محصول", gradient: "from-amber-400 to-orange-600" },
              { number: "150+", label: "برند معتبر", gradient: "from-indigo-500 to-purple-700" },
              { number: "99%", label: "رضایت", gradient: "from-emerald-500 to-teal-600" }
            ].map((stat, index) => (
              <div key={index} className="text-center p-6 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/30 group hover:shadow-2xl transition-all duration-300">
                <div className={`text-4xl font-extrabold mb-2 bg-clip-text text-transparent bg-linear-to-r ${stat.gradient}`}>
                  {stat.number}
                </div>
                <div className="text-gray-700 font-medium text-lg">{stat.label}</div>
            ...
            return (
              <div
                ...
                className={`group relative bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-xl transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 ${
                  activeCategory === category.title ? 'scale-[1.03] z-20' : 'z-10'
                }`}
              >
...
<Link href={category.href} className="absolute inset-0 z-20">
          <span className="sr-only">{category.title}</span>
                ...
                <div className="relative p-8 flex flex-col items-center text-center z-10">
                  {category.featured && (
                    <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-sm text-white text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1.5 border border-white/30">
                      <Crown size={14} /> ویژه
                    </div>
                  )}
                  
                  {/* Icon Container */}
                  <div className="w-24 h-24 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center mb-8 border border-white/30 shadow-inner group-hover:scale-110 transition-transform duration-500">
                  ...
                  <p className="text-white/90 text-sm mb-6 grow">
                    {category.description}
                  </p>
                  ...
                  <Link
                    href={category.href}
                    className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl font-bold text-white bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300"
                  >
                    مشاهده محصولات
